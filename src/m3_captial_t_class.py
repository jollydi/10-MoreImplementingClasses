...
class CapitalT(object):
    ...
    def clone(self):
        ...
        new_h_rect = self.h_rect.clone()
        new_v_rect = self.v_rect.clone()
        new_T = CapitalT(rg.Point(new_h_rect.corner_1.x + (new_h_rect.get_width() / 2), new_h_rect.corner_1.y +
                                 (new_h_rect.get_height() / 2)), new_h_rect.get_width(), new_v_rect.get_height(),
                                  new_h_rect.get_height())
