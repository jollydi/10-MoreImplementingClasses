...
class Line(object):
    ...
    def clone(self):
        ...
        new_line = Line(self.start.clone(), self.end.clone())
        self.num_of_clones = self.num_of_clones + 1
        return new_line
    ...
    def line_plus(self, other_line):
        ...
        new_line = Line(self.start.plus(other_line.start), self.end.plus(other_line.end))
        return new_line
    ...
    def line_minus(self, other_line):
        ...
        new_line = Line(self.start.minus(other_line.start), self.end.minus(other_line.end))
        return new_line
    ...
    def midpoint(self):
        ...
        mid = self.start.halfway_to(self.end)
        return mid
